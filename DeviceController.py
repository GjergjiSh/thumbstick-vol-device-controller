...
class DeviceController:
    ...
    def get_active_output_device(self) -> tuple:
        ...
        self.active_device = (self.active_device_index,
    ...
    def switch_output_device(self, direction) -> tuple:
        ...
        self.device_switcher.Set_Output_Device_By_Index(
            self.active_device_index)
        self.active_device_name = self.output_devices[self.active_device_index]
        self.active_device = (self.active_device_index,
                              self.active_device_name)
        print("Active Output Device: {} {}".format(
            self.active_device_index, self.active_device_name))
